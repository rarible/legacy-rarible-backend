let docs = List.map (fun (n, t, d) -> (n, (t, d, None, None))) @@ [
    ...
    "items_by_id", "getNftItemById", "Get NFT item by id" ; (* conflit *)
    ...
    "collections_by_id", "getNftCollectionById", "collections_by_id" ; (* conflit *)
    ...
    "orders_by_hash", "getOrderByHash", "Get order by hash" ; (* conflit *)
